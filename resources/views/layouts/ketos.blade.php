            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                    ...
                    <div class="container my-auto bg-white p-3">
                        <a class="btn btn-primary" href="{{ route('admin.insertKetos') }}">Tambah Ketua Osis</a>
                      ...
                      <table id="example" class="table table-striped text-start" style="width:100%">
                        ...
                        <tbody>
                            @forelse ($ketua_osis as $ketos)
                            <tr>
                                <td>{{ $ketos->no }}</td>
                                <td>{{ $ketos->name }}</td>
                                <td>{{ $ketos->kelas }}</td>
                                <td> <img src="{{ asset('/storage/ketos/'.$ketos->image) }}" class="rounded" style="width: 150px"></td>
                                <td>{!! $ketos->visi !!}</td>
                                <td>{!! $ketos->misi !!}</td>
                                <td>{!! $ketos->slogan !!}</td>
                                <td>{{ $ketos->vote }}</td>
                                <td>
                                    <div class="button d-flex gap-3">
                                        <a href="{{ route('ketos.edit', ['id' => $ketos->id]) }}" class="btn btn-warning">Edit</a>
                                        <form action="{{ route('ketos.destroy', ['id' => $ketos->id]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                                <div class="alert alert-danger">
                                    Data Ketua Osis belum Tersedia.
                                </div>
                            @endforelse
                        </tbody>
