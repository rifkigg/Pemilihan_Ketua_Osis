                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('users.update', $users->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <x-text-input id="name" class="block mt-1 w-full form-control" type="text" name="name" :value="old('name')" value="{{ old('name', $users->name) }}" required autofocus autocomplete="name" />
                            ...
                            <div class="form-group">
                                ...
                                <x-text-input id="role" class="block mt-1 w-full form-control" type="text" name="role" :value="old('role')" value="{{ old('role', $users->role) }}" required autofocus autocomplete="role" />
                            ...
                            <div class="form-group">
                                ...
                                <x-text-input id="nisn" class="block mt-1 w-full form-control" type="text" name="nisn" :value="old('nisn')" value="{{ old('nisn', $users->nisn) }}" required autofocus autocomplete="nisn" />
                                <x-input-error :messages="$errors->get('nisn')" class="mt-2" />
                            </div>
                            <div class="form-group">
                                <x-input-label for="status" :value="__('Status')" />
                                <select name="status" id="status" class="form-select form-control" value="{{ old('status', $users->status) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_kelamin" class="form-control" id="jenis_kelamin" value="{{ old('jenis_kelamin', $users->jenis_kelamin) }}">
